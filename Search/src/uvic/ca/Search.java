...
public class Search {
	...
	public void printTree(Node root) {
		...
		double h = problem.h(currentNode.state);
		double g = currentNode.path_cost;
		double f = h + g;
		System.out.println('\n');
		...
		System.out.print(currentNode.state + "(g=" + g + ", h=" + h + ", f=" + f + ")");
		System.out.print("order=" + currentNode.depth);
